          ...
          <div class="row">
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img src="https://rfbd.hs.llnwd.net/siteContent/bkimages/detail/JD498.jpg" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img src="https://images-na.ssl-images-amazon.com/images/I/51lFAzVQUxL._SX342_BO1,204,203,200_.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                  <p class="card-text">livro</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img src="https://www.adazing.com/wp-content/uploads/2012/06/life-of-pi.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                  <p class="card-text">livro</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQoi71Vn4IOa1wytwExd2iXSZK2paANqadv9A&usqp=CAU" class="card-img-top" alt="...">
                <div class="card-body">
                  <p class="card-text">livro</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img src="https://http2.mlstatic.com/kit-livros-irmos-felipe-neto-e-luccas-neto-D_NQ_NP_701997-MLB27179412656_042018-F.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                  <p class="card-text">livro</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img src="https://m.media-amazon.com/images/I/51DqlZ7qkwL.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                  <p class="card-text">livro</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
